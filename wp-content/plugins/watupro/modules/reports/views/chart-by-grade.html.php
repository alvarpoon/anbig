...
<div class="wrap">
	...
	<?php if(empty($in_shortcode)):?>
		<p><?php _e('Shortcode to display this page:', 'watupro')?> <input type="text" size="30" readonly="true" onclick="this.select();" value="[watupror-chart-by-grade <?php echo $exam->ID?>]"></p>
	<?php endif;?>		
</div>

<script>
<?php if(empty($in_shortcode)):?>window.onload = function() {<?php endif;?>
    var r<?php echo $exam->ID?> = Raphael("chart<?php echo $exam->ID?>", '100%', <?php echo $in_shortcode ? 300 : 600?>);
    r<?php echo $exam->ID?>.piechart(<?php echo $in_shortcode ? 150 : 300?>, <?php echo $in_shortcode ? 100 : 200?>, <?php echo $in_shortcode ? 100 : 200?>, [<?php foreach($grades_arr as $grade=>$vals) echo $vals['percent'].",";?>],	{
