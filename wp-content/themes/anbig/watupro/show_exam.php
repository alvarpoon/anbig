...
<div <?php if($exam->time_limit>0 and empty($_POST['watupro_start_timer'])):?>style="display:none;"<?php endif;?> id="watupro_quiz" class="container quiz-area <?php if($single_page) echo 'single-page-quiz'; ?>">
